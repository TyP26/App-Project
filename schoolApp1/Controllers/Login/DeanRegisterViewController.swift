//
//  DeanRegisterViewController.swift
//  schoolApp1
//
...
final class DeanRegisterViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        displayNameField.frame = CGRect(x: 30, y: lastNameField.bottom + 10 , width: scrollView.width - 60, height: 52)
        emailField.frame = CGRect(x: 30, y: displayNameField.bottom + 10 , width: scrollView.width - 60, height: 52)
    ...
    @objc private func registerButtonTapped() {
        ...
        DatabaseManager.shared.userExists(with: email, completion: { [weak self] exists in
            ...
            FirebaseAuth.Auth.auth().createUser(withEmail: email, password: password, completion: {authResult, error  in
                ...
                UserDefaults.standard.set(true, forKey: "is_dean")
                UserDefaults.standard.set(nil, forKey: "grade")
                
                DatabaseManager.shared.provideSession(for: email, completion: nil)
                ...
                let chatUser = ChatAppUser(firstName: firstName, lastName: lastName, displayName: displayName, emailAddress: email, isDean: true, grade: nil)
...
extension DeanRegisterViewController: UITextFieldDelegate {
...
extension DeanRegisterViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
